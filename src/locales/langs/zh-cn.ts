  ...
  page: {
        ...
        desc_1954: [
          {
            ...
            items: [
              ...
              {
                value:
                  '面向非政府官员的招待，如果人均费用≤人民币300元仅需在E-hospitality系统录入招待相关信息，E-hospitality中无需审批。',
                items: []
              },
              {
                value:
                  '面向非政府官员的招待，如果人均消费高于人民币300元但不超过500元（含500元），须获得直线经理及部门经理的事先审批。如果人均消费高于500元，还须获得合规BP的事先审批。',
                items: []
              },
              {
                value:
                  '向政府官员提供招待，如果人均消费不超过300元（含300元），须获得直线经理的事先审批。如果超过300元，还须获得部门经理及合规BP的事先审批。',
                items: []
              }
            ]
          },
          {
            ...
            items: [
              {
                value:
                  '员工提供给第三方招待时，应禁止索取、禁止不当影响、避免利益冲突、禁止现金或现金等价物、禁止私人利益。',
                items: []
              },
              {
                value: '包括但不限于医疗卫生专业人士、政府官员、协会、客户、经销商、供应商、服务商及其他业务合作方。',
                items: []
              }
            ]
          },
          {
            label: '除上述内容外，申请人还应遵循以下合规要求',
            items: [
              {
                value:
            ...
            items: [
              ...
              },
              {
                ...
                items: [
                  {
                    value:
                      '提供招待人均费用≤人民币300元（且不涉及政府官员）仅需在E-hospitality系统录入招待相关信息，E-hospitality中无需审批；',
                    items: []
                  },
                  {
                    value:
        ...
        desc_1391: [
          {
            ...
            items: [
              ...
              {
                value:
                  '向政府官员提供招待，如果人均消费不超过300元（含300元），须获得直线经理的事先审批。如果超过300元，还须获得部门总监及合规BP的事先审批。',
                items: []
              }
            ]
          },
    ...
    givingGifts: {
      ...
      policy: {
        ...
        desc_1954: [
          {
            label: '请注意，此处用于登记和记录提供给第三方的礼品',
            items: [
              {
                value: '推广处方药产品时：',
                items: [
                  { value: '禁止向医疗卫生专业人士提供推广辅助用品 （包括但不限于便利贴、鼠标垫、日历等）；' },
                  {
                    value:
                      '仅当公司自办会议或第三方会议中（例如拜耳卫星会），在满足“最小价值”和“最少数量”前提下可以提供仅带有拜耳名称和/或标识的笔和记事本；'
                  },
                  {
                    value: '前述第二种情况需事先获得直线经理、部门负责人及对应合规伙伴的批准。'
                  }
                ]
              },
              {
                value: '推广非处方药及影像诊断业务部医疗器械产品时, 向第三方提供的推广辅助用品必须满足以下所有条件：',
                items: [
                  { value: '最小价值（单价≤ 100元人民币）；' },
                  { value: '与接受者工作相关；' },
                  { value: '印有拜耳标志/商标/产品标识；' },
                  { value: '事先获得直线经理的批准。' }
                ]
              },
              {
                value: '原则上不允许向第三方提供风俗礼品。仅当满足以下所有条件时允许向健康消费品经销商提供风俗礼品：',
                items: [
                  { value: '健康消费品各部门负责人提前批准；' },
                  { value: '非贵重的（≤ 200元人民币每人）；' },
                  { value: '极少的情况（仅限两个中国传统节日：春节和中秋节）；' },
                  { value: '允许的物品包括，食品、茶、鲜花、植物、手工艺或通常与传统节日相关的地方特产；' },
                  { value: '不允许的物品包括雪茄、酒、社交活动或体育赛事门票等。' }
                ]
              }
            ]
          },
