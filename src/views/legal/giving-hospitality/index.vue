...
<template>
  <a-drawer title="给予招待申请" :size="size" width="800" :open="open" @close="onClose">
    ...
    <a-descriptions title="招待信息" layout="vertical">
      <a-descriptions-item label="备注" :span="3">
        - 仅非营销性质的礼品或招待须事先在eGift系统中申请。
        <br />
        - 如果单价小于人民币300元，无需审批。
        <br />
        - 如果单价高于人民币300元（含300元），须获得部门总监、国家经理及合规的审批。
        <br />
        - 向国家工作人员提供礼品和招待，均须获得合规的审批。
      </a-descriptions-item>
      <a-descriptions-item label="商务就餐/娱乐活动应满足以下所有条件" :span="3">
        - 有合法的目的
        <br />
        - 符合预先评估的商业惯例
        <br />
      ...
      <a-descriptions-item label="商业就餐/娱乐活动不能为" :span="3">
        - 铺张浪费
        <br />
        - 奢华
        <br />
        - 在非法活动地或附近举行
        <br />
        - 附送的礼品不符合“礼品和招待守则或附表”的规定
        <br />
        - 在名声不佳的场所（例如脱衣舞俱乐部或不合时宜的酒吧）或其他类似的地方
      </a-descriptions-item>
    </a-descriptions>
    <a-descriptions title="招待列表" layout="vertical"></a-descriptions>
    <a-form>
      <a-row :gutter="24">
        <a-col span="14">
