...
const columns: TableColumnsType = [
  { title: '申请者', width: 100, dataIndex: 'name', key: 'name', fixed: 'left' },
  { title: '申请日期', width: 100, dataIndex: 'age', key: 'age', fixed: 'left' },
  { title: 'CWID', dataIndex: 'address', key: '1', width: 150 },
  { title: '部门', dataIndex: 'address', key: '2', width: 150 },
  { title: '公司', dataIndex: 'address', key: '3', width: 150 },
  { title: '申请类型', dataIndex: 'address', key: '4', width: 150 },
...
const apply_value = ref({ value: 'sz', label: 'Zhuo Chen <chen.zhuo@bayer.com>' });
...
<template>
  <a-drawer title="给予礼品申请表" :size="size" :open="open" @close="onClose">
    ...
    <a-form>
      <a-row :gutter="24">
        <a-col span="14">
          <a-form-item label="提供礼物原因">
            <a-input placeholder="提供礼物原因..."></a-input>
          </a-form-item>
        </a-col>
        <a-col span="10">
          <a-form-item label="礼品描述">
      ...
      <a-row :gutter="24">
        <a-col span="8">
          <a-form-item label="提供日期">
            <a-date-picker v-model:value="provide_date" />
          </a-form-item>
        </a-col>
        <a-col span="5">
      ...
      <a-row :gutter="24">
        ...
        <a-col span="10">
          <a-form-item label="礼品接收者是否是拜耳现有客户? ">
            <a-select ref="select" v-model:value="value1" @focus="focus" @change="handleChange">
